...
Got it 👍
Below is **ONE SINGLE, COMPLETE `README.md` CODE BLOCK**.
You can **copy–paste this entire block at once** into your `README.md` file — no edits needed.
...
Correlation-based metric robust to class imbalance:
\[
MCC \in [-1, 1]
\]

### 3️⃣ Precision–Recall AUC (PR-AUC)
Preferred over ROC-AUC for highly imbalanced datasets.
...
- Same splits used across all models for fair comparison

---

## 📈 Statistical Significance Testing
To ensure observed performance differences are **not due to randomness**:

- **Wilcoxon Signed-Rank Test** → pairwise model comparison  
- **Friedman Test** → comparison across multiple models  
...
Download the **UCI Credit Card Fraud Detection Dataset**
and place it in:
...
### ✅ This is **industry + research ready**
If you want next, I can:
- Write **resume bullets** for this repo  
- Add **SMOTE experiments code**  
- Convert this into a **paper-style report**  
- Help you **explain this perfectly in interviews**
